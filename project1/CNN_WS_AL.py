...
"""
define the CNN model with auxiliary loss and weight sharing
"""
...
"""
Train CNN_WS_AL model with cross entropy loss and SGD
    lr: stands for learning rate
    nb_epochs: stands for the number of epochs in a training process
    momentum: momentum factor of SGD
...
"""
def train_model(model, train_input, train_classes, train_target, mini_batch_size = 100, lr = 0.1, nb_epochs = 25, loss_ratio = 0.5, momentum = 0.9):
...
parameters:
    ...
    loss_ratio: the factor of auxiliary losses to compute the total training loss from three loss functions
    momentum: momentum factor in optimizer
return:
...
"""    
def evaluate_accuracy(model_class, train_iter = 20, size = 1000, mini_batch_size = 100, lr = 0.005, nb_epochs = 25, loss_ratio = 0.5, momentum = 0.9):
    losses_vals = []
    train_accuracys = []
    test_accuracys = []
    for n in range(train_iter):
        ...
        #train the model
        model.train(True)
        losses = train_model(model, train_input, train_classes, train_target, mini_batch_size, lr, nb_epochs, loss_ratio,momentum)
